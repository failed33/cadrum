...
fn main() -> Result<(), Error> {
	...
	let result=[
		build_pipe()?.color("#b0d4f1"),
		build_sphere()?.color("#f1c8b0").translate(DVec3::X * 14.0),
		build_partial()?.color("#b0f1c8").translate(DVec3::X * 28.0),
		build_channel()?.color("#d4b0f1").translate(DVec3::X * 42.0)
	];
